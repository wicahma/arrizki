...
const Loading = ({ isActive }: LoadingProps) => {
  return (
    <div
      ...
      } fixed z-[2000] flex top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 justify-center items-center bg-black/20 transition-all duration-200 backdrop-blur-lg aspect-square`}
    >
