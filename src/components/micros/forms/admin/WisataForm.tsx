...
const WisataForm = (props: any) => {
  ...
  useEffect(() => {
    if (dataWisataPilihan) {
      setFieldValue("_id", dataWisataPilihan._id);
      setFieldValue("status", dataWisataPilihan.status);
                                ...
                                <div className="space-x-1">
                                  ...
                                  >
                                    <Button
                                      ...
                                      onClick={() =>
                                        values.jenisPaket[index].pax.length >
                                          1 && arrayHelpersPax.remove(paxIndex)
                                      }
                                      className="p-2 rounded-full"
                                      color="red"
                                    >
