...
const CustomWisataRow = ({ data, i, deleteContext }: CustomWisataRow) => {
  ...
  return (
    ...
    >
      ...
      <td>
        <p
          className="
        text-gray-900 whitespace-no-wrap px-6 text-center"
        >
          {data.namaReservant}
        </p>
      </td>
      ...
      <td className="py-3 px-6 text-center">
        <div className="flex item-center bg-gray-300 space-x-2 px-3 py-1 rounded-full w-fit mx-auto justify-center">
          ...
          >
            <div
              onClick={() => dispatch(setSelectedResCustom(data))}
...
export default CustomWisataRow;
